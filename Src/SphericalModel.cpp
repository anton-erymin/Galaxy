...
void SphericalModel::calcPotential() {
    ...
    //poisson::poisson1d(5000, m_gridXMin, m_gridXMax, m_N, m_potential, std::bind(&SphericalModel::rightPartPoisson, _1));
...
lpVec3 SphericalModel::getGravityVector(lpVec3 pos) const {
